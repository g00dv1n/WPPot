...
<table class="table form-table mdocs-settings-table">
	<tr>
		...
		<td>
			<input type="checkbox" name="mdocs-disable-bootstrap" value="1"  <?php checked(1,$mdocs_disable_bootstrap) ?> /> <span><?php _e('Bootstrap'); ?></span>
			<input type="checkbox" name="mdocs-dropdown-toggle-fix" value="1"  <?php checked(1,$mdocs_dropdown_toggle_fix) ?> /> <span><?php _e('Bootstrap Dropdown Fix'); ?></span><br>
			<small><?php _e('Using one, both or none of these Bootstrap fixes my help.', 'mdocs'); ?></small><br>
	...
	<tr>
		...
		<td>
			...
			<input type="checkbox" name="mdocs-remove-posts-from-homepage" value="1"  <?php checked(1,$mdocs_remove_posts_from_homepage) ?> /> <span><?php _e('Hide All Post From Homepage'); ?></span><br>
